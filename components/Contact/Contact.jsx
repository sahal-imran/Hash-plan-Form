...
function Contact() {
  ...
  return (
    <>
      {/* Content Box */}
      <Box id={'Contact-Content-Box'} sx={{ width: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', background: 'transparent' }} >
        {/* Logo Bar */}
        ...
        <Box sx={{ width: '100%', minHeight: '90vh', display: 'flex', flexDirection: { md: 'row', xs: 'column' }, justifyContent: 'center', alignItems: 'center', background: 'transparent', px: { md: 0, xs: 2 },pb:{md:0,xs:2} }} >
